...
class UniversalLogger:
    ...
    def progress(self, iterable, message=None, total=None):
        """
        Display progressbar for the given iterable.
        The function calls TQDM under the hood.

        :param iterable: Iterable to display progressbar for.
        :param message: Optional message that will be displayed
        :param total: Optional number of items in total
        :return: Iterable with tqdm progressbar configured
        """
        if self._enable_progress:
            return tqdm(iterable, desc=message, total=total)
        return iterable
